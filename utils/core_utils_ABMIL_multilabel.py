...
from models.model_ABMIL_multilabel import Attention, GatedAttention
from models.model_VarMIL_multilabel import VarMIL
...
def train(datasets, cur, args):
    ...
    model_dict = {'L' : 1024, 'D' : 128, 'n_classes': args.n_classes, 'n_labels': args.n_labels}

    if args.model_type == 'attention':
            model = Attention(**model_dict)
    elif args.model_type == 'gated_attention':
            model = GatedAttention(**model_dict)
    elif args.model_type == 'VarMIL':
            model = VarMIL(**model_dict)
    else:
