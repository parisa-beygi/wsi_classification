...
from models.model_local_vit_multilabel import LocalViT
...
def train(datasets, cur, args):
    ...
    if args.model_type == 'local_vit':
        model_dict = {'n_classes': args.n_classes, 'n_labels': args.n_labels}
    ...
    print('\nInit Loaders...', end=' ')
    train_loader = get_split_loader_multilabel(train_split, training=True, testing = args.testing, collate='ml_extended')
    val_loader = get_split_loader_multilabel(val_split,  testing = args.testing, collate='ml_extended')
    test_loader = get_split_loader_multilabel(test_split, testing = args.testing, collate='ml_extended')
    print('Done!')
