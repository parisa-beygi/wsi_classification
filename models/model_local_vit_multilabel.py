...
class LocalViT(nn.Module):
    def __init__(self,     
        ...
        self.encoder = LocalTransformerEncoder(input_emb_size=input_emb_size, emb_size=emb_size, **kwargs)
        self.classifier = ClassificationHead(emb_size, n_classes, n_labels)
