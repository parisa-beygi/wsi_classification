...
from utils.core_utils_vos import train
...
def main(args):
    ...
    for i in folds:
        ...
        val_results, test_results, val_dict, test_dict, split_counts, val_embs_before, val_embs_after, test_embs_before, test_embs_after = train(datasets, i, args)
        print ('******************************************')
        print ('test_embs_before')
        print (test_embs_before)

        print ('val_embs_before')
        print (val_embs_before)
...
parser.add_argument('--model_type', type=str, choices=['clam_sb_vos'], default='clam_sb_vos', 
                    help='type of model (default: clam_sb + vos, clam w/ single attention branch)')
