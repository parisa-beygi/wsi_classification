...
from utils.core_utils_vos_multilabel_generic import train, test
...
### VOS specific options
"""
    instance-level training args:
    k_sample_id: number of ID highly-attended patch instances
...
parser.add_argument('--subtyping', action='store_true', default=False, 
                     help='subtyping problem') # not used now, but kept for later
parser.add_argument('--inst_loss', type=str, choices=['svm', 'ce', None], default=None,
                     help='instance-level clustering loss function (default: None)')
parser.add_argument('--no_inst_module', action='store_true', default=False,
                     help='disable instance-level training')
parser.add_argument('--bag_weight', type=float, default=0.7,
                    help='clam: weight coefficient for bag-level loss (default: 0.7)')
parser.add_argument('--B', type=int, default=8, help='numbr of positive/negative patches to sample for clam')
parser.add_argument('--k_sample_ood', type=int, default=4, help='number of OOD instance embedding samples for each class')
parser.add_argument('--sample_number', type=int, default=2400, help='total number of ID patch samples in each class queue for computing the distribution parameters')
parser.add_argument('--sample_from', type=int, default=50000, help='number of OOD instance embedding samples for each class')
parser.add_argument('--start_epoch', type=int, default=5,
                    help='from which epoch to start adding instance training')                    

parser.add_argument('--testing_mode', action='store_true', default=False, help='Whether to test or train')
...
encoding_size = 1024
settings = {'testing_mode': args.testing_mode,
            'num_splits': args.k, 
